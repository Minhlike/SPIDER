...
| P0-C rule registry/planning/proof graph | **PARTIAL EXPERIMENT RESULT — versioned fail-closed edge/question registries, gap states, claim lifecycle và scoped justification DAG qua Web/MCP fixture PASS; stale/temporal rules và full deterministic replay benchmark chưa làm** |
