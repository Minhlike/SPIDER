...
- M1 PARTIAL: scoped digest/evidence/graph, compare/coverage, benchmark có dữ liệu. Snapshot/delta và continuation của history/graph đã có; bounded reachability projection và continuation run comparison còn thiếu.
