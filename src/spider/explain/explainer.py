    ...
    async def explain_assertion(session: AsyncSession, assertion_id: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "rule": {"id": asrt.inference_rule,
                     "version": (asrt.metadata_json or {}).get("rule_version"),
                     "registry_version": (asrt.metadata_json or {}).get("rule_registry_version"),
                     "evidence_requirement": (asrt.metadata_json or {}).get("evidence_requirement")},
