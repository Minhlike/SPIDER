    ...
    async def build_insights(session, case_id: str, case_rec, target_id=None, question="all") -> Dict[str, Any]:
        ...
        for observation in observations:
            ...
            if raw.get("match_basis") not in ("exact_public_email", "email_hash_public_profile",
                                               ...
                                               "coccoc_search_lead_revalidated"):
                continue
        ...
        phone_insights = {
            ...
            "national_format": phone_seed.get("national_format"),
            "country_calling_code": phone_seed.get("country_calling_code"),
            ...
            "number_type_label_vi": phone_seed.get("number_type_label_vi"),
            "detected_prefix": phone_seed.get("detected_prefix"),
