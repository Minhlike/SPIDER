...
def investigate(page, base_url, target):
    page.goto(base_url)
    ...
    # Reload to attach the WebSocket listener before bootstrap connects.
    page.reload()
    ...
    expect(page.locator("#case-status-badge")).to_have_text("COMPLETED", timeout=15000)
